function [C] = CalculateCdC( Cfarray, Parray, Cytokines)
% This function takes the cytokine conditions and a given [C/EBP]f and 
% [PU.1] concentration and calculates the corresponding [C/EBP]t
% concentration along the C/EBP nullcline.
global S1 S2 S3
sigma = 3.2;
